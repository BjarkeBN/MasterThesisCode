...
tic
pl1 = zeros(length(vall)-1);
pla1 = zeros(length(vall)-1);
...
pl2 = zeros(length(vall)-1);
pla2 = zeros(length(vall)-1);
...
pl3 = zeros(length(vall)-1);
pla3 = zeros(length(vall)-1);
parfor i=1:length(vall)-1
    if (length(vall(i):vall(i+1)) > 3 && (sub(locs(i))-(sub(vall(i))+sub(vall(i+1)))/2) > 0.2)
        ff = fit(dtsub(vall(i):vall(i+1)).',sub(vall(i):vall(i+1)).',f,'Lower',[min(sub(vall(i):vall(i+1))),0,dtsub(vall(i)),0],'Upper', [1,0.1,dtsub(vall(i+1)),inf],'Startpoint',[0,0.1,dtsub(locs(i)),1]);
        pl3(i) = ff.c;
...
pl4 = zeros(length(vall)-1);
pla4 = zeros(length(vall)-1);
parfor i=1:length(vall)-1
    if (length(vall(i):vall(i+1)) > 3 && (sub(locs(i))-(sub(vall(i))+sub(vall(i+1)))/2) > 0.2)
        ff = fit(dtsub(vall(i):vall(i+1)).',sub(vall(i):vall(i+1)).',f,'Lower',[min(sub(vall(i):vall(i+1))),0,dtsub(vall(i)),0],'Upper', [1,0.1,dtsub(vall(i+1)),inf],'Startpoint',[0,0.1,dtsub(locs(i)),1]);
        pl4(i) = ff.c;
...
pl5 = zeros(length(vall)-1);
pla5 = zeros(length(vall)-1);
parfor i=1:length(vall)-1
    if (length(vall(i):vall(i+1)) > 3 && (sub(locs(i))-(sub(vall(i))+sub(vall(i+1)))/2) > 0.2)
        ff = fit(dtsub(vall(i):vall(i+1)).',sub(vall(i):vall(i+1)).',f,'Lower',[min(sub(vall(i):vall(i+1))),0,dtsub(vall(i)),0],'Upper', [1,0.1,dtsub(vall(i+1)),inf],'Startpoint',[0,0.1,dtsub(locs(i)),1]);
        pl5(i) = ff.c;
...
pl6 = zeros(length(vall)-1);
pla6 = zeros(length(vall)-1);
parfor i=1:length(vall)-1
    if (length(vall(i):vall(i+1)) > 3 && (sub(locs(i))-(sub(vall(i))+sub(vall(i+1)))/2) > 0.2)
        ff = fit(dtsub(vall(i):vall(i+1)).',sub(vall(i):vall(i+1)).',f,'Lower',[min(sub(vall(i):vall(i+1))),0,dtsub(vall(i)),0],'Upper', [1,0.1,dtsub(vall(i+1)),inf],'Startpoint',[0,0.1,dtsub(locs(i)),1]);
        pl6(i) = ff.c;
...
%     if (pl3(b) < pl1(i+1) && pl4(c) < pl2(a+1))
%         v1(end+1) = 0.02/(pl2(a)-pl1(i))*1000;
%         v2(end+1) = 0.02/(pl3(b)-pl2(a))*1000;
...
xlabel('Velocity [m/s]')
ylabel('Count')
title('Histogram of blob velocities 3204')
